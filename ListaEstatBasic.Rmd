...
8. A altura dos universitários do sexo masculino de uma certa universidade é dada como 169cm. Você, como aluno dessa universidade, percebe que nos últimos anos muitos alunos de outros países vieram estudar nela. Isso faz supor que o valor de referência para a altura tenha mudado. Para testar sua hipótese, você coletou uma amostra com 200 indivíduos e obteve o valor médio de 172cm com desvio padrão de 6cm. Ao nível de 5\%, testar a sua hipótese.