...
9. Leitões de uma suinocultura foram alimentados com uma nova ração rica em proteína ao longo de dois meses. Espera-se que, ao final desse período, tenham, em média, massa igual a $50kg$. Para testar se os animais atingiram esse valor, você coleta uma amostra: \{47, 51, 46, 52, 45, 45, 50, 53, 49, 52 \} $kg$. Ao nível de 5\%, você considera que os animais, alimentados com a nova ração, apresentam crescimento adequado para a idade?

```{r echo=FALSE,results='hide'}
x <- c(47, 51, 46, 52, 45, 45, 50, 53, 49, 52)
mean(x)
sd(x)
```
