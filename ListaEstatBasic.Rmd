...
[^1]: Este artigo é uma lista de exercícios sobre __estatística básica__. Provavelmente, esta lista ganhará novos exercícios ao longo do tempo. Caso encontre erros, queira fazer comentários, ou troca uma ideia sobre o artigo, por favor, me escreva: omarcnpereiraead@gmail.com
...
* As receitas de duas concessionárias estão apresentadas na Tabela \@ref(tab:conces). Qual delas apresenta maior dispersão? Discuta os resultados.
