...
O _RMarkdown_ junta a linguagem de programação `R` e a linguagem de marcação `markdown`. Isto facilita a mistura de códigos de texto e de progração em `R`.
